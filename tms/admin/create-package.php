...
<html>
<head>
<title>Pip Pip Go | Admin Package Creation</title>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagetype" id="packagetype" placeholder=" Day trip/Long day trip" required>
									</div>
								</div>
